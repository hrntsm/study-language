// Attribure 込みで Brep を Rhino へ Bake する方法
...
#region Members
  ...
  private void RunScript(Brep brep, bool write, ref object A)
  {
    ...
    if(write == true)
    {
      ...
      objAttr.LayerIndex = index;
      objAttr.SetUserString("aaa","10");
      aDoc.Objects.AddBrep(brep, objAttr);
    }
  }

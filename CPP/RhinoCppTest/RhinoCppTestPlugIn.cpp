// RhinoCppTestPlugIn.cpp : defines the initialization routines for the plug-in.
//
...
RHINO_PLUG_IN_NAME(L"RhinoCppTest");

// Rhino plug-in id
// Provide a unique uuid for this plug-in.
RHINO_PLUG_IN_ID(L"F1413291-28A7-415A-855F-78EF0FD08311");
...
RHINO_PLUG_IN_DESCRIPTION(L"RhinoCppTest plug-in for Rhinoceros®");
...
// The one and only CRhinoCppTestPlugIn object
static class CRhinoCppTestPlugIn thePlugIn;

/////////////////////////////////////////////////////////////////////////////
// CRhinoCppTestPlugIn definition

CRhinoCppTestPlugIn& RhinoCppTestPlugIn()
{
	// Return a reference to the one and only CRhinoCppTestPlugIn object
	return thePlugIn;
}

CRhinoCppTestPlugIn::CRhinoCppTestPlugIn()
{
	// Description:
	//   CRhinoCppTestPlugIn constructor. The constructor is called when the
	//   plug-in is loaded and "thePlugIn" is constructed. Once the plug-in
	//   is loaded, CRhinoCppTestPlugIn::OnLoadPlugIn() is called. The
...
const wchar_t* CRhinoCppTestPlugIn::PlugInName() const
{
	// Description:
...
const wchar_t* CRhinoCppTestPlugIn::PlugInVersion() const
{
	// Description:
...
GUID CRhinoCppTestPlugIn::PlugInID() const
{
	// Description:
	...
	// {F1413291-28A7-415A-855F-78EF0FD08311}
...
BOOL CRhinoCppTestPlugIn::OnLoadPlugIn()
{
	// Description:
...
void CRhinoCppTestPlugIn::OnUnloadPlugIn()
{
	// Description:
